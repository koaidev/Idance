...
class _LoginPageState extends State<LoginPage>
    ...
    try {
      ...
      if (e.code == 'user-not-found') {
        Fluttertoast.showToast(
            msg:
                'Không tìm thấy người dùng nào cho email này. Vui lòng đăng ký mới.');
      } else if (e.code == 'wrong-password') {
        Fluttertoast.showToast(msg: 'Sai mật khẩu. Vui lòng thử mật khẩu khác');
      }
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    _isLogged = authService != null ? true : false;
    return !_isLogged
        ? new Scaffold(
            key: _scaffoldKey,
            appBar: AppBar(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                isLoading = true;
                                await login(loginEmailController.text,
