...
import 'package:oxoo/models/all_live_tv_by_category.dart';
import 'package:oxoo/models/all_package_model.dart';
import 'package:oxoo/models/content_by_country_model.dart';
import 'package:oxoo/models/country_list_model.dart';
import 'package:oxoo/models/events_details_model.dart';
import 'package:oxoo/models/events_model.dart';
import 'package:oxoo/models/favourite_model.dart';
import 'package:oxoo/models/favourite_response_model.dart';
import 'package:oxoo/models/genre_list_model.dart';
...
import 'package:oxoo/models/password_set_model.dart';
import 'package:oxoo/models/rent_history_model.dart';
import 'package:oxoo/models/search_result_model.dart';
import 'package:oxoo/models/tv_connection_model.dart';
import 'package:oxoo/models/tv_series_details_model.dart';
import 'package:oxoo/models/user_details_model.dart';
import 'package:oxoo/models/user_model.dart';
import 'package:oxoo/models/video_comments/ad_comments_model.dart';
import 'package:oxoo/models/video_comments/add_reply_model.dart';
import 'package:oxoo/models/video_comments/all_comments_model.dart';
import 'package:oxoo/models/video_comments/all_reply_model.dart';
...
class Repository {
  ...
  Future<SubmitResponseModel?> setUserPassword(
    ...
    try {
      final response = await dio.post(
          "${ConfigApi().getApiUrl()}/set_password?id=$userID",
          data: formData);
      print(response);
      if (response.statusCode == 200) {
  ...
  Future<TvSeriesDetailsModel?> getTvSeriesDetailsData(
    ...
    try {
      final response = userId != null
          ? await dio.get(
              "${ConfigApi().getApiUrl()}/single_details?type=tvseries&id=$seriesId&user_id=$userId")
          : await dio.get(
  ...
  Future<SearchResultModel?> searchResultData({String? query}) async {
    ...
    try {
      final response = await dio.get(
          "${ConfigApi().getApiUrl()}/search?q=$query&type=null&range=null");
